...
import {
  offset as sphereOffset
} from 'ol/sphere.js';
import {
  linearRings as linearRingsArea
...
var Polygon = /** @class */ (function (_super) {
  ...
  Polygon.prototype.setLayout = function (layout, coordinates, nesting) {
    /** @type {number} */
    var stride;
    if (layout) {
  ...
  Polygon.prototype.setCoordinates = function (coordinates, opt_layout) {
    ...
    var ends = deflateCoordinatesArray(this.flatCoordinates, 0, coordinates, this.glStride, this.ends_);
